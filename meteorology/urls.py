...
urlpatterns = [
    ...
    path('station/<int:station_id>/', views.get_single_weather_station, name='get_single_weather_station'),
    path('update_station/<int:station_id>/', views.update_weather_station, name='update_weather_station'),
    path('delete_station/<int:station_id>/', views.delete_weather_station, name='delete_weather_station'),
    ...
    #path('data/<int:station_id>/weather_data/<int:data_id>/', views.get_single_weather_data, name='get_single_weather_data'),
